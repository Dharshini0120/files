...
import { PageLoader, useApiWithLoader, withPageLoader } from "@frontend/shared-ui";
                ...
                <Box sx={{ border: '1px solid #e4e5e7', borderRadius: '10px', padding: 2, backgroundColor: '#fff', minHeight: 600 }}>
                    ...
                    <TableContainer style={{ borderRadius: '12px', overflow: 'hidden' }} >
                        <Table >
                            ...
                            <TableBody>
                                <TableRow >
                                    <TableCell>{new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</TableCell>
                                    <TableCell>
                                ...
                                <TableRow >
                                    <TableCell>{new Date(-1).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</TableCell>
                                    <TableCell>
