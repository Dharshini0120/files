...
import { AddOutlined, Edit, Delete, Send } from '@mui/icons-material';
                    ...
                    return (
                      <TableRow key={userId}>
                        ...
                        <TableCell>
                          ...
                          />
                          <IconButton onClick={() => console.log('Resend email to:', user.email)}>
                            <Send style={{ fontSize: '25px', color: '#4caf50' }} />
                          </IconButton>
                        </TableCell>
                      </TableRow>
                    );
